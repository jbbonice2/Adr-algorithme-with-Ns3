...
main(int argc, char* argv[])
{
    ...
    //   ADR-Lite : Binary search based ADR without packet history (ns3::AdrComponent with UseAdrLite=true)
    ...
    if (adrEnabled && !useAdrLite) {
        ...
        // Configure AdrComponent in ADR-Lite mode
        Config::SetDefault("ns3::AdrComponent::UseAdrLite", BooleanValue(true));
        Config::SetDefault("ns3::AdrComponent::ChangeTransmissionPower", BooleanValue(true));
        Config::SetDefault("ns3::AdrComponent::ChangeCodingRate", BooleanValue(true));
        Config::SetDefault("ns3::AdrComponent::ChangeChannel", BooleanValue(true));
    }
